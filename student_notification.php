					...
					") or die();
									...
									if ($count  > 0) {
										while ($row = mysqli_fetch_array($query)) {
											...
											$query_yes_read = mysqli_query($conn, "select * from notification_read where notification_id = '$id' and student_id = '$session_id'") or die();
									...
									?>
									<a href="view_attendence_table.php<?php echo '?id=' . $session_id; ?>" class="btn btn-info"><i class="icon-arrow-left"></i> View Attendence</a>
