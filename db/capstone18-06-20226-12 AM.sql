...
# Database: capstone
# Generation Time: 2022-06-18 01:12:25 +0000
# ************************************************************
...
INSERT INTO `fyp_proposal` (`id`, `student1_id`, `student2_id`, `student3_id`, `student4_id`, `student5_id`, `project_name`, `proposal_file`, `is_approved`, `is_submitted`, `marks`, `teacher_id`, `class_id`)
VALUES
	(4,220,222,223,0,0,'test','uploads/projects/Shape 1.png',0,0,0,9,23),
	(5,220,222,223,0,0,'test2','uploads/projects/Screen Shot 2022-03-20 at 3.05.31 AM.png',1,0,10,9,23),
	(6,220,222,223,0,0,'test3','uploads/projects/capstone15-06-20221-05 AM.sql',1,0,0,10,23),
	(7,220,222,223,0,0,'testing','uploads/projects/Shape 1.png',1,0,0,10,23),
	(8,220,222,223,0,0,'uyfuyf','uploads/projects/Shape 1.png',1,0,0,9,23);
...
INSERT INTO `notification` (`notification_id`, `teacher_class_id`, `notification`, `date_of_notification`, `link`)
VALUES
	(25,205,'Add Task file name','2022-06-18 05:19:56','assignment_student.php'),
	(26,205,'Add Task file name','2022-06-18 05:20:23','assignment_student.php'),
	(27,205,'Add Task file name','2022-06-18 05:22:48','assignment_student.php'),
	(28,205,'Add Task file name','2022-06-18 05:36:35','fyp_student.php'),
	(29,205,'Add Task file name','2022-06-18 05:38:00','fyp_student.php');
...
INSERT INTO `notification_read` (`notification_read_id`, `student_id`, `student_read`, `notification_id`)
VALUES
	(6,220,'yes',27),
	(7,220,'yes',26),
	(8,220,'yes',25);
...
CREATE TABLE `student` (
  ...
  CONSTRAINT `student_ibfk_2` FOREIGN KEY (`project_id`) REFERENCES `fyp_proposal` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

LOCK TABLES `student` WRITE;
/*!40000 ALTER TABLE `student` DISABLE KEYS */;

INSERT INTO `student` (`student_id`, `firstname`, `lastname`, `class_id`, `username`, `password`, `location`, `status`, `id`, `has_project`, `project_id`)
VALUES
	(220,'Sohaib','Arif',23,'02-235182-014','098f6bcd4621d373cade4e832627b4f6','uploads/cartoon-face-avatar.jpg','Registered',1,0,NULL),
	(222,'syeda','nusrat',23,'02-235182-026','098f6bcd4621d373cade4e832627b4f6','gulshan','registered',2,0,NULL),
	(223,'Ali','kasim',24,'02-235182-004','098f6bcd4621d373cade4e832627b4f6','gulshan','Registered',3,0,NULL);
...
CREATE TABLE `tasks` (
  ...
  `class_id` int(11) NOT NULL,
  `ans_loc` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `tasks` (`id`, `location`, `class_id`, `ans_loc`)
VALUES
	(6,'../admin/uploads/9265_File_Shape 1.png',23,'admin/uploads/4349_File_Shape 1.png');
...
CREATE TABLE `teacher` (
  ...
  `project_count` decimal(1,0) NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `teacher` (`teacher_id`, `username`, `password`, `firstname`, `lastname`, `department_id`, `location`, `about`, `teacher_status`, `teacher_stat`, `id`, `is_supervisor`, `project_count`)
VALUES
	(9,'1001','098f6bcd4621d373cade4e832627b4f6','Tanveer','Khan',4,'uploads/NO-IMAGE-AVAILABLE.jpg','','Registered','Activated',1,1,3),
	(10,'1002','098f6bcd4621d373cade4e832627b4f6','Dr.Humera','Farooq',4,'uploads/NO-IMAGE-AVAILABLE.jpg\r\n','','Registered','Activated',2,1,0),
	(11,'1003','098f6bcd4621d373cade4e832627b4f6','Talha','Khan',4,'gulshan','','Registered','',3,0,0);
